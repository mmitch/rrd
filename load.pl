#!/usr/bin/perl
# $Id: load.pl,v 1.1 2003-04-05 16:37:08 mitch Exp $
#
...
# rrdtool update $datafile $( PROCS=`ls -d /proc/[0-9]*|wc -l|tr -d ' '`; read L1 L2 L3 DUMMY < /proc/loadavg ; echo $( date +\%s ):${L1}:${L2}:${L3}:${PROCS} )
